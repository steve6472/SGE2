...
import steve6472.sge.gui.components.dialog.DialogContainer;
import steve6472.sge.gui.components.schemes.*;
...
public abstract class MainApp
{
	...
	public static FloatBuffer loadMatrix(Matrix4f matrix)
	{
		MATRIX_BUFFER.clear();
...
//		glMatrixMode(GL_MODELVIEW);
	...
	protected int getTextMaxLength()
	{
		return 65536;
	}
