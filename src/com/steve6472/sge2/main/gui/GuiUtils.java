...
import com.steve6472.sge2.main.gui.components.Button;
import com.steve6472.sge2.main.gui.components.ButtonEvents;
import com.steve6472.sge2.main.gui.components.DragFrame;
...
public class GuiUtils
{
	...
	public static Button createExitButton(Gui gui)
	{
		...
		exit.addEvent(new ButtonEvents()
		{
			...
			public void click()
			{
				glfwSetWindowShouldClose(gui.getMainApp().getWindow(), true);
			}
		});
